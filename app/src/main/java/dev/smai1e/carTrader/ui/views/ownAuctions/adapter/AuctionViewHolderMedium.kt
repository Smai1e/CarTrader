...
class AuctionViewHolderMedium(
    ...
    fun bind(auction: AuctionUI, onClick: (Long) -> Unit) {
        ...
        binding.apply {
            ...
            brandTextView.text = resources.getString(
            ...
            statusTextView.text = resources.getString(
                R.string.state,
                resources.getString(auction.auctionStatus.nameId)
            )
    ...
    companion object {
        fun inflateFrom(parent: ViewGroup): AuctionViewHolderMedium {
            val layoutInflater = LayoutInflater.from(parent.context)
            val binding = AuctionItemMediumBinding.inflate(layoutInflater, parent, false)
            return AuctionViewHolderMedium(binding)
        }
    }
}