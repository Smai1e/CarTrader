...
import dev.smai1e.carTrader.databinding.ActivityMainBinding
import dev.smai1e.carTrader.ui.views.tabs.TabsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private val destinationListener = NavController.OnDestinationChangedListener { _, destination, arguments ->
        changeTitle(prepareTitle(destination.label, arguments))
    ...
    private fun isSignedIn(): Boolean = args.isSigmedIn
    ...
    fun changeTitle(title: String, subtitle: String? = null) {
